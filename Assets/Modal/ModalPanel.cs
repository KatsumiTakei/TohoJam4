...
public class ModalPanel : MonoBehaviour
  {
	public TMPro.TextMeshProUGUI Title;     //The Modal Window Title
	public TMPro.TextMeshProUGUI Question;  //The Modal Window Question (or statement)
	...
	public void MessageBox(Sprite IconPic, string Title, string Question, UnityAction YesEvent, UnityAction NoEvent, UnityAction CancelEvent, UnityAction OkEvent, bool IconActive, string MessageType)
	  {
		...
		if (MessageType == "YesNoCancel")  //If the user has asked for the Message Box type "YesNoCancel"
		  {
			...
			Button1.onClick.RemoveAllListeners (); Button1.onClick.AddListener(YesEvent);    Button1.onClick.AddListener(ClosePanel); Button1.GetComponentInChildren<TextMeshProUGUI>().text = "Yes";
			Button2.onClick.RemoveAllListeners (); Button2.onClick.AddListener(NoEvent);     Button2.onClick.AddListener(ClosePanel); Button2.GetComponentInChildren<TextMeshProUGUI>().text = "No";
			Button3.onClick.RemoveAllListeners (); Button3.onClick.AddListener(CancelEvent); Button3.onClick.AddListener(ClosePanel); Button3.GetComponentInChildren<TextMeshProUGUI>().text = "Cancel";
		...
		if (MessageType == "YesNo")        //If the user has asked for the Message Box type "YesNo"
		  {
			...
			Button2.onClick.RemoveAllListeners (); Button2.onClick.AddListener(YesEvent);     Button2.onClick.AddListener(ClosePanel); Button2.GetComponentInChildren<TextMeshProUGUI>().text = "Yes";
			Button3.onClick.RemoveAllListeners (); Button3.onClick.AddListener(NoEvent);      Button3.onClick.AddListener(ClosePanel); Button3.GetComponentInChildren<TextMeshProUGUI>().text = "No";
		...
		if (MessageType == "Ok")           //If the user has asked for the Message Box type "Ok"
		  {
			Button1.onClick.RemoveAllListeners ();
			Button2.onClick.RemoveAllListeners (); Button2.onClick.AddListener(OkEvent);     Button2.onClick.AddListener(ClosePanel); Button2.GetComponentInChildren<TextMeshProUGUI>().text = "Ok";
